...
<!--
  Pantalla Perfil.
  js/perfil.js carga y actualiza datos del usuario usando /api/perfil y sus
  subrutas. common.js mantiene menu, tema y sesion.
-->
<!doctype html>
<html lang="es">
  <head>
  ...
  <body>
    ...
    <script src="<?= app_url('js/perfil.js') ?>?v=20260616historyphoto"></script>
